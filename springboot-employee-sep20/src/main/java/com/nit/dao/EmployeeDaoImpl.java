...
public class EmployeeDaoImpl implements EmployeeDao{
	...
	public void saveEmpoloyee(Employee emp) {
		jdbcTemplate.update(INSERT,emp.getName(),emp.getAddress(),emp.getSalary(),emp.getEmail());
	...
	public void updateEmpoloyee(Employee emp) {
		jdbcTemplate.update(UPDATE,emp.getName(),emp.getAddress(),emp.getSalary(),emp.getEmail(),emp.getId());
